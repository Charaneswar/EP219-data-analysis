...
plt.hist(teachers_per_school_rural,bins=8,histtype='bar',rwidth=0.3)
plt.show()
#hist for urban
plt.xlabel("number of teachers per urban school")
plt.ylabel("number of states")
plt.title("number of states with a number per urban pre-primary school")
plt.hist(teachers_per_school_urban,bins=8,histtype='bar',rwidth=0.3)
plt.show()
#hist for combined
...
plt.hist(teachers_per_school_combined,bins=8,histtype='bar',rwidth=0.3)
plt.show()
